...
class MLPClassificationEnsembleTest(parameterized.TestCase):
    ...
    @parameterized.parameters(itertools.product([10.0], [1, 10], [False, True]))
    def test_evenly_spaced_sampler(
        self, max_val: float, num_samples: int, use_bias: bool
    ):
    ...
    def _check_seq_data_env_params(
        self,
        ...
        self.assertEqual(
            env.y_train.shape, (ntrain_batches, train_batch_size, output_dim)
        )
        self.assertEqual(
            env.X_train.shape, (ntrain_batches, train_batch_size, input_dim)
        )
    ...
    def test_make_matlab_demo_environment(
        ...
        self._check_seq_data_env_params(
            env, input_dim, output_dim, ntrain, ntest, train_batch_size, test_batch_size
        )

    @parameterized.parameters(
        itertools.product([0], [1, 3], [10], [10], [1, 2], [1, 2])
    )
    def test_make_random_poly_regression_environment(
        self,
        seed: int,
        degree: int,
        ntrain,
        ...
        env = base.make_random_poly_regression_environment(
            key,
            degree,
            ntrain,
            ntest,
    ...
    @parameterized.parameters(
        itertools.product([0], [1, 10], [1, 10], [10], [10], [0.0, 0.5], [1, 2], [1, 2])
    )
    def test_make_random_linear_regression_environment(
        self,
        seed: int,
        nfeatures: int,
        ntargets: int,
        ...
        env = base.make_random_linear_regression_environment(
            key,
            nfeatures,
            ntargets,
            ntrain,
        ...
        self._check_seq_data_env_params(
            env, nfeatures, ntargets, ntrain, ntest, train_batch_size, test_batch_size
        )
    ...
    def test_make_classification_mlp_environment(
        self,
        seed: int,
        nfeatures: int,
        ntargets: int,
        ...
        env = base.make_classification_mlp_environment(
            key,
            nfeatures,
            ntargets,
            ntrain,
        ...
        output_dim = 1
        self._check_seq_data_env_params(
            env, nfeatures, output_dim, ntrain, ntest, train_batch_size, test_batch_size
        )
    ...
    def test_make_regression_mlp_environment(
        self,
        seed: int,
        nfeatures: int,
        ntargets: int,
        ...
        env = base.make_regression_mlp_environment(
            key,
            nfeatures,
            ntargets,
            ntrain,
    ...
    def test_make_environment_from_torch_dataset(
        self, train_batch_size: int, test_batch_size: int
    ):
        dataset = torchvision.datasets.MNIST
        classification = True
        env = base.make_environment_from_torch_dataset(
            dataset, classification, train_batch_size, test_batch_size
        )
